...
namespace TreeTraversal
{
    ...
    public class CNode
    {
        ...
        public CNode(int data, int interval_x)
        {
        ...
        public void AddChildren(int Ldata, int Rdata, int root_x, int root_y, int interval_x)
        {
    ...
    public class CTree
    {
        ...
        public void Generate(CNode r, int levels, int interval_x)
        {
            ...
            if (levels > 1)
            {
                r.AddChildren(rnd.Next(0, 50), rnd.Next(0, 50), r.X, r.Y, r.Interval_X);
